    ...
    <>
      <div className="row justify-content-center">
        <div className="col-10 col-md-5 mt-3 text-center">
          <img className="img-fluid rounded shadow" src={require('../../img/capstec.png')} alt="Capstec" />
        </div>
      ...
      <div className="row justify-content-center mt-5">
        <div className="col-10 col-md-5 order-1 order-md-2 mt-3 text-center">
          <img className="img-fluid rounded shadow" src={require('../../img/air-quality.png')} alt="Air-Quality" />
        </div>
